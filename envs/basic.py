...
import torch
from utils import all_combinations, mat_to_graph
...
class BasicModel:
    ...
    def __init__(self, *, g_dist, verbose=False, seed = None):
    ...
    def sample_obs(self, n_samples, g, theta = None, toporder=None):
    ...
    def log_marginal_likelihood(self, x, all_g, z_g=None, numpy = False):
    ...
    def sample_posterior_weights_given_obs(self, g, x):
    ...
    def log_prob_parameters_mc(self, theta, n_samples=3e4):
    ...
    def log_marginal_likelihood_mc(self, x, n_samples=3e4):
